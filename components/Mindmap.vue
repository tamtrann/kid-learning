<template>
  <div class="mindmap">
    ...
    <mindmap-selector :mindmapList="mindmapList" :listIsUpdated="listIsUpdated" @OpenCreator="openCreator" @LoadMindmap="load"/>
    <mindmap-creator v-if="creatorIsShown" :id="selectedMindmap.id" :nodes="selectedMindmap.nodes" :connections="selectedMindmap.connections"
